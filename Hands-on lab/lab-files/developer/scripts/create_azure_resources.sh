...
AZURE_CREDENTIALS=$(az ad sp create-for-rbac --name "fabmedical-$MCW_SUFFIX-buildagent" --role contributor --scopes /subscriptions/$AZURE_SUBSCRIPTION_ID/resourceGroups/fabmedical-${MCW_SUFFIX} --sdk-auth)
